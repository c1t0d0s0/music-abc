...
const ja = {
	...
	score: {
		...
		volume: "音量",
		instrument: "音色",
		instrumentNote: "選ぶと、ABC に「%%MIDI program 番号」の行を書き込みます。",
		mute: "ミュート",
		unmute: "ミュートを解除",
	},
	download: {
	...
	editor: {
		...
		scoreTools: "楽譜を用意する",
		resizePanes: "入力欄と楽譜の幅を調整（ダブルクリックで元に戻す）",
...
const en: Messages = {
	...
	score: {
		...
		instrumentNote: "Choosing one writes a “%%MIDI program number” line into the ABC.",
		mute: "Mute",
		unmute: "Unmute",
	},
	download: {
	...
	editor: {
		...
		resizePanes: "Resize the editor and score panes (double-click to reset)",
