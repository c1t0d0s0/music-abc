...
const ja = {
	...
	song: {
		...
		hint: "音符をクリックすると、その音だけを鳴らせます。再生バーの「%」でテンポを変えられます。",
	...
	editor: {
		heading: "ABC エディタ",
		lead: "左の欄に ABC 記法を書くと、右の楽譜がすぐに更新されます。内容はこのブラウザに自動で保存されます。",
		new: "新規",
		openFile: "ファイルを開く",
		loadSong: "収録曲から読み込む…",
...
const en: Messages = {
	...
	song: {
		...
		hint: "Click a note to hear just that note. Use the “%” box in the player to change the tempo.",
	...
	editor: {
		heading: "ABC Editor",
		lead: "Type ABC notation on the left and the score on the right updates as you type. Your work is saved in this browser automatically.",
		new: "New",
		openFile: "Open file",
